...
<head>
    ...
    <link rel="icon" href="<?php echo base_url() ?>/asset/images/Logo1.png" type="image/x-icon">
            ...
            <div class="form_content center-block">
                <form action="login/login_check" method="post">
                    <div class="form-group">
                        <input type="text" class="form-control" id="email" name="rid" placeholder="Renata Id" required="required">
                    </div>
                    <div class="form-group">
