...
<div class="body_wrapper"> <!-- MAIN BODY PART -->
    <div class="container_wrapper reneta_shop">
        <div class="form_content">
            ...
            <form onsubmit="return create_user()" action="<?php echo base_url() ?>user/edit_sm_user" method="post"
                  enctype="multipart/form-data">
                <div class="form-group">
                    <input style="" name="user_name" id="offer_title" type="text" class="form-control"
                           placeholder="User Name" required="required" value="<?php echo $sm['0']['name'] ?>">
                </div>
                <div class="form-group">
                    <input style="" name="user_type" id="user_type" type="hidden" class="form-control"
                           placeholder="User Type"  value="<?php echo $sm['0']['user_type '] ?>">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <input  type="text" disabled="disabled" class="form-control"
                           placeholder="SM CODE" value="<?php echo $sm['0']['sm_code'] ?>">
                    <input  type="hidden"  name="sm_code" class="form-control" id="sm_code"
                           placeholder="SM CODE" value="<?php echo $sm['0']['sm_code'] ?>">
                </div>
                <div class="form-group">
                    <input type="text" name="designation" class="form-control" id="designation"
                           placeholder="Designation" value="<?php echo $sm['0']['designation'] ?>">
                </div>
                <div class="form-group">
                    <select style="color: #0C529E" name="depot_code" id="depot_code" class="form-control">
                        <?php foreach ($depots as $depot) {
                            if ($sm['0']['tbl_depot_depot_code'] == $depot['depot_code']) { ?>
                ...
                <div class="form-group">
                    <select style="color: #0C529E;" name="business_code" id="business_code"
                            class="form-control">
                        <?php foreach ($business as $bus) { if ($sm['0']['tbl_business_business_code'] == $bus['business_code']) {?>
                            <option selected="selected"
