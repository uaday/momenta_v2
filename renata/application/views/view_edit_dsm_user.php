...
<div class="body_wrapper"> <!-- MAIN BODY PART -->
    <div class="container_wrapper reneta_shop">
        <div class="form_content">
            ...
            <form onsubmit="return create_user()" action="<?php echo base_url() ?>user/edit_dsm_user" method="post"
                  enctype="multipart/form-data">
                <div class="form-group">
                    <input style="" name="user_name" id="offer_title" type="text" class="form-control"
                           placeholder="User Name" required="required" value="<?php echo $dsm['0']['name'] ?>">
                </div>
                <div class="form-group">
                    <input style="" name="user_type" id="user_type" type="hidden" class="form-control"
                           placeholder="User Type"  value="<?php echo $dsm['0']['user_type'] ?>">
                </div>
                <div class="form-group">
                    <input style="" name="renata_id" id="offer_title" type="text" class="form-control"
                           ...
                           value="<?php echo $dsm['0']['renata_id'] ?>">
                ...
                <div class="form-group">
                    <input  type="text" disabled="disabled" class="form-control"
                            placeholder="DSM CODE" value="<?php echo $dsm['0']['dsm_code'] ?>">
                    <input  type="hidden"  name="dsm_code" class="form-control" id="dsm_code"
                            placeholder="DSM CODE" value="<?php echo $dsm['0']['dsm_code'] ?>">
                </div>
                <div class="form-group">
                    <input  type="text"  class="form-control" name="rsm_code" id="rsm_code"
                            placeholder="RSM CODE" value="<?php echo $dsm['0']['tbl_user_rsm_rsm_code'] ?>">
                </div>
                <div class="form-group">
                    <input type="text" name="designation" class="form-control" id="designation"
                           placeholder="Designation" value="<?php echo $dsm['0']['designation'] ?>">
                </div>
                <div class="form-group">
                    <select style="color: #0C529E" name="depot_code" id="depot_code" class="form-control">
                        <?php foreach ($depots as $depot) {
                            if ($dsm['0']['tbl_depot_depot_code'] == $depot['depot_code']) { ?>
                ...
                <div class="form-group">
                    <select style="color: #0C529E;" name="business_code" id="business_code"
                            class="form-control">
                        <?php foreach ($business as $bus) { if ($dsm['0']['tbl_business_business_code'] == $bus['business_code']) {?>
                            <option selected="selected"
