...
class Medicine_literature_model extends CI_Model {
    ...
    public function insert_version_data($version_id,$point1,$point2,$point3,$audio1_test,$audio2_test,$audio3_test,$drug_audio_test,$image_test,$drug_id)
    {
        $point1=$this->db->escape_str($point1);
        $point2=$this->db->escape_str($point2);
        $point3=$this->db->escape_str($point3);
        $sql="UPDATE tbl_drug_detail_version SET drug_detail_image=N'$image_test',point1=N'$point1',point2=N'$point2',point3=N'$point3',audio1=N'$audio1_test',audio2=N'$audio2_test',audio3=N'$audio3_test' WHERE detail_version_id='$version_id'";
        $result=$this->db->query($sql);
        ...
        $sql3="UPDATE tbl_drug_des SET drug_name_audio=N'$drug_audio_test' WHERE tbl_drug_drug_id='$drug_id'";
        $this->db->query($sql3);
