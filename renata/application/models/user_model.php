...
class User_model extends CI_Model {
    ...
    {
        $sql="INSERT INTO tbl_login(renata_id,name,password,user_type,designation,status,account_create_date) VALUES (N'$renata_id',N'$user_name',md5('123456') ,N'$user_type',N'$designation','1',CURRENT_DATE )";
        $this->db->query($sql);
    }
    ...
    public function insert_user5($user_name,$renata_id,$user_type,$designation,$depot_code,$business_code,$rsm_code,$sm_code)
    {
        $sql="INSERT INTO tbl_login(renata_id,name,password,user_type,designation,status,account_create_date) VALUES (N'$renata_id',N'$user_name',md5('123456') ,N'$user_type',N'$designation','1',CURRENT_DATE )";
        $this->db->query($sql);
        $sql1="INSERT INTO tbl_user_rsm(rsm_code,renata_id,rsm_name,rsm_designation,tbl_depot_depot_code,tbl_business_business_code,tbl_user_sm_sm_code) VALUES (N'$rsm_code',N'$renata_id',N'$user_name',N'$designation',N'$depot_code',N'$business_code',N'$sm_code')";
        $this->db->query($sql1);
    }
    ...
    {
        $sql="SELECT * FROM tbl_login l,tbl_user_sm s WHERE l.renata_id=s.renata_id AND user_type='4'";
        $this->db->query("set character_set_results='utf8'");
        $result=$this->db->query($sql);
        return $result->result_array();
    }
    ...
    {
        $sql="SELECT * FROM tbl_login l,tbl_user_rsm r WHERE l.renata_id=r.renata_id AND user_type='5'";
        $this->db->query("set character_set_results='utf8'");
        $result=$this->db->query($sql);
        return $result->result_array();
    }
    ...
    {
        $sql="SELECT * FROM tbl_login l,tbl_user_dsm d WHERE l.renata_id=d.renata_id AND user_type='6'";
        $this->db->query("set character_set_results='utf8'");
        $result=$this->db->query($sql);
        return $result->result_array();
    }
    ...
    public function edit_sm_user($user_name,$renata_id,$user_type,$designation,$sm_code,$depot_code,$business_code)
    {
        $sql="UPDATE tbl_login SET name='$user_name',user_type='$user_type',designation='$designation' WHERE renata_id='$renata_id'";
        $this->db->query($sql);
        $sql1="UPDATE tbl_user_sm SET sm_name='$user_name',sm_code='$sm_code',sm_designation='$designation',tbl_depot_depot_code='$depot_code',tbl_business_business_code='$business_code'";
        $this->db->query($sql1);
    }
    public function edit_rsm_user($user_name,$renata_id,$user_type,$designation,$rsm_code,$sm_code,$depot_code,$business_code)
    {
        $sql="UPDATE tbl_login SET name='$user_name',user_type='$user_type',designation='$designation' WHERE renata_id='$renata_id'";
        $this->db->query($sql);
        $sql1="UPDATE tbl_user_rsm SET rsm_name='$user_name',tbl_user_sm_sm_code='$sm_code',rsm_designation='$designation',tbl_depot_depot_code='$depot_code',tbl_business_business_code='$business_code',rsm_code='$rsm_code'";
        $this->db->query($sql1);
    }
    public function edit_dsm_user($user_name,$renata_id,$user_type,$designation,$rsm_code,$dsm_code,$depot_code,$business_code)
    {
        $sql="UPDATE tbl_login SET name='$user_name',user_type='$user_type',designation='$designation' WHERE renata_id='$renata_id'";
        $this->db->query($sql);
        $sql1="UPDATE tbl_user_dsm SET dsm_name='$user_name',tbl_user_rsm_rsm_code='$rsm_code',dsm_designation='$designation',tbl_depot_depot_code='$depot_code',tbl_business_business_code='$business_code',dsm_code='$dsm_code'";
        $this->db->query($sql1);
    }

    public function reset_password($renata_id)
    {
        $sql="UPDATE tbl_login SET password=md5(123456),change_pass_status=0 WHERE renata_id='$renata_id'";
        $this->db->query($sql);
    }
