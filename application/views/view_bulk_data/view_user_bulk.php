...
<div class="main-content">
    ...
    <div class="page-title">
        ...
        <div class="title-env">
            <h1 class="title">USER BULK</h1>
            <p class="description">Add your user by bulk user</p>
        </div>
        ...
        <div class=" col-sm-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form method="post" action="<?php echo base_url() ?>bulk_data/user_bulk_upload_file" accept-charset="utf-8"
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" name="user_bulk" id="user_bulk"  class="form-control" data-validate="required" data-message-required="Please Upload the csv file">
                        </div>

                        <div class="form-group">
                            <button type="submit" class="btn btn-success">Save USER Information</button>
                        </div>
